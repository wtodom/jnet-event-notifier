// Collapsed region is mutation-summary.js
if (true) {
...
function handleSystemMessage(messages) {
  ...
  for (var i = 0; i < mesageList.length; i++) {
...
// var messageObserver = new MutationSummary({
//   callback: handleMessageMessage,
//   queries: [{ element: 'div.message' }]
// });

// function handleMessageMessage(message) {
//   if (message[0].added.length == 1) {
//     var text = message[0].added[0].innerText.split('↵');
//     console.log(text);
//   }
// }
